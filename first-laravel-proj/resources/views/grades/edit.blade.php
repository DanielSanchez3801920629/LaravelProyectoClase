...
@section('container')
    <main class="container">
        <h1 class="alert alert-success text-center"><i class="fa-solid fa-users"></i> &nbsp;Edit the grade</h1>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="grade_name" id="grade_name"
                               aria-describedby="grade_name" value="{{old('grade_name', $grade->grade_name)}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="grade_value_percentage" id="grade_value_percentage"
                               aria-describedby="grade_value_percentage" value="{{old('grade_value_percentage', $grade->grade_value_percentage)}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" name="grade_deadline" id="grade_deadline"
                               aria-describedby="grade_deadline" value="{{old('grade_deadline', $grade->grade_deadline)}}">
                    </div>
                </div>
            </div>
            @if($errors->any())
